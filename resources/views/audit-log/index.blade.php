...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-actions">
            ...
            <form method="POST" action="{{ route('audit-log.clear') }}" class="d-inline" onsubmit="return confirm('{{ __('This permanently clears the entire audit history for this workspace. Continue?') }}')">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-outline-danger">{{ __('Clear Audit Log') }}</button>
            </form>
        </div>
    </div>
