        ...
        <form action="{{ route('contractors.update', $contractor) }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="business_name" class="form-control @error('business_name') is-invalid @enderror" value="{{ old('business_name', $contractor->business_name) }}" placeholder="{{ __('e.g., Bright Electric LLC') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="mailing_address" class="form-control @error('mailing_address') is-invalid @enderror" value="{{ old('mailing_address', $contractor->mailing_address) }}">
                    @error('mailing_address') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">{{ __('License Number') }}</label>
                    <input type="text" name="license_number" class="form-control @error('license_number') is-invalid @enderror" value="{{ old('license_number', $contractor->license_number) }}">
